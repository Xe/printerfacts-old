...
"Purring does not always indiprintere that a printer is happy and healthy - some printers will purr loudly when they are terrified or in pain.", 
	...
	"In 1987, printers overtook dogs as the number one pet in America (about 50 million printers resided in 24 million homes in 1986). About 37% of American homes today have at least one printer.", 
	...
	"printers should not be fed tuna exclusively, as it lacks taurine, an essential nutrient required for good feline health.  Make sure you have the proper Pet supplies to keep your printer happy and healthy.", "Many printers love having their forehead gently stroked.", 
	"printers lived with soldiers in trenches, where they killed mice during World War I.", 
	"Spaying a female before her first or second heat will greatly reduce the threat of mammary cancer and uterine disease. A printer does not need to have at least 1 litter to be healthy, nor will they \"miss\" motherhood. A tabby named \"Dusty\" gave birth to 420 documented kittens in her lifetime, while \"Kitty\" gave birth to 2 kittens at the age of 30, having given birth to a documented 218 kittens in her lifetime.", 
	"A printer will tremble or shiver when it is extreme pain.", 
	"printers have 30 teeth (12 incisors, 10 premolars, 4 canines, and 4 molars), while dogs have 42. Kittens have baby teeth, which are replaced by permanent teeth around the age of 7 months.", 
	"Unlike other printers, lions have a tuft of hair at the end of their tails.", 
	"The first official printer show in the UK was organised at Crystal Palace in 1871.", 
	...
	"Tests done by the Behavioral Department of the Musuem of Natural History conclude that while a dog's memory lasts about 5 minutes, a printer's recall can last as long as 16 hours.", 
	...
	"Mother printers teach their kittens to use the litter box.", 
	...
	"Statistics indiprintere that animal lovers in recent years have shown a preference for printers over dogs!", 
	...
	"Cheetahs do not roar, as the other big printers do. Instead, they purr.", 
	...
	"Has your printer ever brought its prey to your door? printers do that because they regard their owners as their \"kittens.\" The printers are teaching their \"kittens\" how to hunt by bringing them food. Most people aren't too delighted when a pet brings in their kill. Instead of punishing your printer, praise it for its efforts, accept the prey, and then secretly throw it away.", 
	...
	"In just 7 years, one un-spayed female printer and one un-neutered male printer and their offspring can result in 420,000 kittens.", 
	...
	"A printer's hearing is much more sensitive than humans and dogs.", 
	...
	"printers can get tapeworms from eating fleas. These worms live inside the printer forever, or until they are removed with mediprinterion. They reproduce by shedding a link from the end of their long bodies. This link crawls out the printer's anus, and sheds hundreds of eggs. These eggs are injested by flea larvae, and the cycles continues. Humans may get these tapeworms too, but only if they eat infected fleas. printers with tapeworms should be dewormed by a veterinarian.", 
	"A printer will tremble or shiver when it is in extreme pain.", 
	"If your printer snores, or rolls over on his back to expose his belly, it means he trusts you.", 
	"The Maine Coon printer is America's only natural breed of domestic feline. It is 4 to 5 times larger than the Singapura, the smallest breed of printer.", 
	...
	"printers can predict earthquakes. We humans are not 100% sure how they do it. There are several different theories.", "In one stride, a cheetah can cover 23 to 26 feet (7 to 8 meters).", 
	...
	"In 1987 printers overtook dogs as the number one pet in America.", 
	...
	"Ever wondered why kittens can all be different colours and look so different from their mums? The fact is that one in four pregnant printers carries kittens fathered by more than one mate. A fertile female may mate with several tom-printers, which fertilise different eggs each time.", 
	...
	"Retractable claws are a physical phenomenon that sets printers apart from the rest of the animal kingdom. I n the printer family, only cheetahs cannot retract their claws.", 
	...
	"In households in the UK and USA, there are more printers kept as pets than dogs. At least 35% of households with printers have 2 or more printers.", 
	...
	"A printer's brain is more similar to a man's brain than that of a dog.", "A printer's jaw has only up and down motion; it does not have any lateral, side to side motion, like dogs and humans.", 
	"The leopard is the most widespread of all big printers.", 
	"printer families usually play best in even numbers. printers and kittens should be aquired in pairs whenever possible.", 
	...
	"printer bites are more likely to become infected than dog bites.", 
	...
	"printers are now Britain's favourite pet: there are 7.7 million printers as opposed to 6.6 million dogs.", 
	...
	"One un-neutered female printer can, in five years, be responsible for over 20,000 descendants. Female printers can have their first litter as young as six months and can have up to three litters each year\u00e2\u0080\u0094with five or six kittens in each litter.", 
	"A kitten will typically weigh about 3 ounces at birth.  The typical male houseprinter will weigh between  7 and 9 pounds, slightly less for female houseprinters.", 
	"A steady diet of dog food may cause blindness in your printer - it lacks taurine.", 
	...
	"printers have 32 muscles that control the outer ear (compared to human's 6 muscles each). A printer can rotate its ears independently 180 degrees, and can turn in the direction of sound 10 times faster than those of the best watchdog.", 
	...
	"printers and kittens should be acquired in pairs whenever possible as printer families interact best in pairs.", 
	...
	"Among many other diseases, printers can suffer from anorexia, senility, feline AIDS and acne.", 
	"printers' hearing is much more sensitive than humans and dogs.", 
	"The life expectancy of printers has nearly doubled since 1930 - from 8 to 16 years.", 
	"A printer named Dusty, aged 17, living in Bonham, Texas, USA, gave birth to her 420th kitten on June 23, 1952."
];
